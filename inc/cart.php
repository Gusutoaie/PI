...
<body>
    ...
    <?php 
        ...
        <?php if(!empty($_SESSION['produs'])):?>
        <div class="a-goleste">
         <p> <a class="sterge-comanda" href="clear_cart.php">Goleste cosul</a></p>
         <p> <a class="trimite-comanda" href="sending.php">Trimite comanda</a> </p>
        </div>
        <?php else: ?>
        <div class="cos-gol">
            <h2>Nu exista nici-un produs in cos!</h2>
            <a href="../index.php">Revin-o la pagina principala!</a>
        </div>
        <?php endif; ?>
    </div>
