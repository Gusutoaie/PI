     ...
     <div class="container">
          <div class="left-side">
              <!-- <ul class="ul-left-side">
                  <li class="ul-1"><i class="fa-regular fa-square-caret-down"></i> Categorii</li>
                  <a href=""> <li>Semne de carte</li> </a>
                  <a href=""> <li>Inimii</li> </a>
                  <a href=""> <li>testasa</li></a>
                  <a href=""> <li>test!!</li> </a>  -->
              </ul>
          </div>
          
          <div class="main-center">
              <div class="container-reducere-produse"><h2>Oferte Speciale</h2></div>
              <!-- <div class="responsive-center"> -->

          <?php
        
              $rezultat = "SELECT * FROM produse";
