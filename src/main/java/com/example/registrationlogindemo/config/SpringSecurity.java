        ...
        http.csrf().disable()
                .authorizeHttpRequests((authorize) ->
                        ...
                        authorize.requestMatchers("/register/**").permitAll()
                                ...
                                .requestMatchers("/tablets").permitAll()
                                .requestMatchers("/smartwatch").permitAll()
                                ...
                                .requestMatchers("/shoppingCart/**").authenticated()
                                .requestMatchers("/sendorder").authenticated()
                                .requestMatchers("/sendorder/succes").authenticated()
                                .requestMatchers("/category").permitAll()
                                .requestMatchers("/shoppingCart/delete/**").authenticated()
