...
public class AuthController {
    ...
    public Integer isLogged(Model model){
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
    ...
    @GetMapping("/{name}")
    public String casa(@PathVariable String name, Model model){
        model.addAttribute("products", productRepository.cautaDupaCategorie(name));
        return "index";
    }
